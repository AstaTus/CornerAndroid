...
import com.astatus.cornerandroid.activity.HomeActivity;
...
public class LoginActivity extends AppCompatActivity {
    ...
    private void initView(){
        ...
        btn.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LoginActivity.this, com.astatus.cornerandroid.activity.RegisterActivity.class);
